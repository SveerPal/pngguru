              ...
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $page->parent }}</td>
                        <td>
                            <a href="{{ route('admin.pages.show',['id'=>$page->id]) }}" class="btn btn-primary text-white" type="button"><i class="fa fa-eye"></i></a>
                            <a href="{{ route('admin.pages.edit',['id'=>$page->id]) }}" class="btn btn-secondary text-white" type="button"><i class="fa fa-pencil"></i></a>
                            <a href="{{ route('admin.pages.delete',['id'=>$page->id]) }}" class="btn btn-danger text-white" type="button"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach 
                </tbody>  
