                ...
                <div class="tile">  
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" type="text" placeholder="Enter Heading First" id="heading_first" name="heading_first" value="{{ old('heading_first') }}"/>
                            @error('heading_first')
                                <div class="alert alert-danger error">{{ $message }}</div>
                            @enderror
                        </div>  
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" type="text" placeholder="Enter Heading Second" id="heading_second" name="heading_second" value="{{ old('heading_second') }}"/>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" type="text" placeholder="Enter Heading Third" id="heading_third" name="heading_third" value="{{ old('heading_third') }}"/>
                            @error('heading_third')
                                <div class="alert alert-danger error">{{ $message }}</div>
                            @enderror
                        </div>                       
