<div class="tile">
    <form action="{{ route('admin.settings.update') }}" method="POST" role="form">
        ...
        <div class="tile-body">
            ...
            <div class="form-group">
                <label class="control-label" for="social_linkedin">Pintrest Profile</label>
                <input
                    class="form-control"
                    type="text"
                    placeholder="Enter pintrest profile link"
                    id="social_pintrest"
                    name="social_pintrest"
                    value="{{ config('settings.social_pintrest') }}"
                />
            </div>
        </div>
