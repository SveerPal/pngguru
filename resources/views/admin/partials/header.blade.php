<header class="app-header">
    <a class="app-header__logo bg-white text-primary" href="{{ route('admin.dashboard') }}" >
        @if (config('settings.site_logo') != null)
            <img src="{{ asset('storage/'.config('settings.site_logo')) }}" id="logoImg" style="width: 150px; height: auto;">
        @else
           {{ config('app.name') }}
        @endif
    </a>
